...
**Important:** If you uninstall the app, all local data will be deleted. We recommend backing up your device regularly.
...
- **Control**: No account creation or personal information required
...
- Clearing app data in iOS Settings will delete all information
...
- **Image Storage:** iOS file system (local)
- **Cloud Services:** None
- **Analytics:** None
- **Advertising:** None

This privacy policy was last reviewed and updated to ensure compliance with Apple App Store guidelines and applicable privacy laws.
